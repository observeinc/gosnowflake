	...
	for !in.IsDelim('}') {
		...
		case "rowType":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v27 execResponseRowType
					easyjson90b16446DecodeGithubComObserveincGosnowflake3(in, &v27)
					out.RowType = append(out.RowType, v27)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson90b16446EncodeGithubComObserveincGosnowflake6(out *jwriter.Writer, in snowflakeRows) {
	...
	_ = first
	{
		...
		if in.RowType == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v28, v29 := range in.RowType {
				if v28 > 0 {
					out.RawByte(',')
				}
				easyjson90b16446EncodeGithubComObserveincGosnowflake3(out, v29)
			}
			out.RawByte(']')
		}
	}
